...
const PERSONAL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    links: [
      {
        label: "Github",
        url: "https://github.com/GODCREATOR333/Instagram_Vector_Search",
      },
    ],
  ...
  },
  {
    ...
    links: [
      {
        label: "Github",
        url: "https://github.com/GODCREATOR333/Simulation_Aerodynamic_Heating",
      },
    ],
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-zinc-200">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        >
          {SITE_DATA.name}
          <span className="hidden sm:inline text-zinc-400 font-normal mx-2">
            /
          </span>
      ...
      <div className="md:col-span-2 space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tighter text-zinc-900 leading-[1.1]">
            ...
            From Algorithms <br />
            <span className="bg-clip-text text-zinc-800">to Actuators.</span>
          </h1>
          ...
          <div className="flex flex-col gap-1 border-l-2 border-blue-200 pl-4 py-1">
            ...
            <span className="text-xs text-zinc-500">
              {SITE_DATA.specialization} • {SITE_DATA.university}
            </span>
          </div>
        </div>
        ...
        <div className="relative bg-zinc-950 rounded-lg border border-zinc-800 overflow-hidden shadow-2xl font-mono text-xs">
          ...
          <div className="p-6 text-zinc-300 space-y-1.5 leading-relaxed">
            <div className="flex gap-3">
              ...
              <span>
                KERNEL: <span className="text-green-500">PREEMPT_RT</span>{" "}
                initialized
              </span>
            </div>
            <div className="flex gap-3">
              ...
              <span>
                HAL: GPIO initialized. UART baud:{" "}
                <span className="text-blue-400">115200</span>
              </span>
            </div>
            <div className="flex gap-3">
            ...
            <div className="flex gap-3">
              ...
              <span>
                CONTROL: MPC Horizon:{" "}
                <span className="text-blue-400">20 steps</span>. Freq:{" "}
                <span className="text-blue-400">1kHz</span>
              </span>
            </div>
            ...
            <div className="p-4 bg-zinc-50 border border-zinc-200 rounded-lg">
              ...
              <div className="flex flex-wrap gap-1.5">
                {SITE_DATA.skills.hardware.map((s, i) => (
                  <span
                    key={i}
                    className="text-xs bg-white px-2 py-1 rounded border border-zinc-200 text-zinc-600"
                  >
                    {s}
                  </span>
                ))}
          ...
          <ul className="space-y-3">
            {SITE_DATA.library.map((book, i) => (
              <li key={i} className="flex justify-between items-start text-sm">
                ...
                <span className="text-[10px] bg-zinc-100 px-1.5 py-0.5 rounded text-zinc-500 font-mono">
                  {book.type}
                </span>
              </li>
            ))}
              ...
              >
                <span
                  className={`w-2 h-2 rounded-full ${
                    tag.includes("Freelance")
                      ? "bg-green-400"
                      : tag.includes("Vision") || tag.includes("AI")
                      ? "bg-purple-400"
  ...
  <section className="max-w-3xl mx-auto px-6 py-16">
    ...
    <div className="bg-white border border-zinc-200 rounded-lg p-8 shadow-sm">
      <p className="text-lg text-zinc-700 mb-8 leading-relaxed">
        ...
        <strong>Robotics, Control Systems, and Mechatronics</strong>. If you are
        working on hard engineering problems—Aerospace, Robotics/Automation,
        Precision Manufacturing, or Autonomous Systems—I'd love to talk.
      </p>

      <div className="space-y-4 font-mono text-sm">
        <a
          href={`mailto:${SITE_DATA.email}`}
          className="flex items-center gap-4 p-3 rounded hover:bg-zinc-50 transition-colors border border-transparent hover:border-zinc-200 group"
        >
          <span className="text-zinc-400 w-24">EMAIL</span>
          <span className="text-zinc-900 group-hover:text-blue-600 break-all">
            {SITE_DATA.email}
          </span>
        </a>
        <a
        ...
        >
          ...
          <span className="text-zinc-900 group-hover:text-blue-600">
            https://www.linkedin.com/in/hari-preetham-934789201/
          </span>
        </a>
      </div>
